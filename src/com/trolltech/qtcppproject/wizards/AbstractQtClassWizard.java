...
public abstract class AbstractQtClassWizard extends Wizard implements
		INewWizard {
	...
	protected void replaceConstructor(StringBuffer s, String className,
			String constructor) {
	...
	public boolean performFinish() {
		IWorkspaceRunnable op = new IWorkspaceRunnable() {
			public void run(IProgressMonitor monitor) throws CoreException,
				...
				try {
					AbstractQtClassWizard.this.createFiles(monitor);
	...
	protected abstract void createFiles(IProgressMonitor paramIProgressMonitor)
